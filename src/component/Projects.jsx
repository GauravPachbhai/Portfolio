...
function Projects() {
  return (
    <div className="flex flex-col gap-2 text-white  items-center justify-center p-4">
    <div>
      <h1 className='text-blue-500 text-3xl mt-4 p-2'>Projects</h1>
    </div>
    <div className='grid grid-cols-1 sm:grid-cols-2 gap-10 w-full mx-auto items-center justify-center mt-5'>
      <Card
