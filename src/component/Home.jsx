...
import BG from '../assets/Frame 6.svg'
    ...
    <>
      <div className='flex flex-col-reverse justify-evenly sm:flex-row sm:justify-between  h-screen text-white items-center '>
        ...
        <div className="flex relative">
          {/* Background Image with wobble effect */}
          <img
            className="wobble bg-transparent object-cover object-center h-64 sm:h-80 lg:h-96 rounded-lg"
            src={BG}
          ...
          <img
            src={Profile2}
            alt="Profile image"
            className="h-64 sm:h-80 lg:h-96 absolute z-10 top-0 left-0"
          />
        </div>
